...
const { BaseEventProvider } = require("./BaseEventProvider");
const { Events } = require("../utils");

class ContestEventProvider extends BaseEventProvider {
  constructor(contestManager, options) {
    super(contestManager.client);

    this.contests = contestManager;
...
module.exports = { ContestEventProvider };
